...
<html lang="en">
  ...
  <head>
    ...
    <title>Shule-System | Reset Password</title>
      ...
      <div class="card">
        <div class="card-body login-card-body">
          ...
          <form action="{{ url('reset/' . $token) }}" method="post">
            ...
            <label class="visually-hidden" for="loginPassword">Confirm Password</label>
            <div class="input-group mb-3">
              <input id="loginPassword" type="password" class="form-control" name=password_confirmation required placeholder="Confirm Password" />
              <div class="input-group-text">
                <span class="bi bi-lock"></span>
              </div>
            </div>
